...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    secondparagragh: Schema.Attribute.Text;
...
export interface ApiCreativeWorkCreativeWork extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blueTitle: Schema.Attribute.String;
    content: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    departments: Schema.Attribute.JSON;
    employees: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiGetInTouchGetInTouch extends Struct.SingleTypeSchema {
...
export interface ApiOurPriceOurPrice extends Struct.SingleTypeSchema {
  collectionName: 'our_prices';
  info: {
    displayName: 'OurPrice';
    pluralName: 'our-prices';
    singularName: 'our-price';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::our-price.our-price'
    > &
      Schema.Attribute.Private;
    priceCards: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::our-price.our-price': ApiOurPriceOurPrice;
